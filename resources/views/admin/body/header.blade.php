         ...
         <ul class="nav navbar-nav">
               ...
               <ul class="dropdown-menu animated bounceIn">
                  ...
                  <li>
                     ...
                     <ul class="menu sm-scrol">
                        ...
                        <li>
                           <a href="#">
                              <i class="fa fa-warning text-warning"></i> Duis malesuada justo eu sapien elementum,
                              in semper diam posuere.
                           </a>
                        </li>
                        <li>
                           <a href="#">
                        ...
                        <li>
                           <a href="#">
                              <i class="fa fa-user text-success"></i> Nullam euismod dolor ut quam interdum, at
            ...
            <li class="dropdown user user-menu">
               <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown"
                  title="admin">
                  <img src="{{ Auth::guard('admin')->user()->profile_photo_url }}" alt="Admin Photo"
                     class="h-8 w-8 rounded-full object-cover">

               </a>
               <ul class="dropdown-menu animated flipInX">
                  <li class="user-body">
                     <a class="dropdown-item" href="{{ route('admin.profile', Auth::guard('admin')->user()->id) }}"><i
                           class="ti-user text-muted mr-2"></i> Profile</a>
                     <a class="dropdown-item"
                        href="{{ route('admin.change-password', Auth::guard('admin')->user()->id) }}"><i
