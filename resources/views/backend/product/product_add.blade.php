                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" name="product_size_en" required=""
                                             class="form-control" value="Small,Midium,Large" data-role="tagsinput">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" name="product_color_en" required=""
                                             class="form-control" value="red,Black,Amet" data-role="tagsinput">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" name="product_color_hin" required=""
                                             class="form-control" value="red,Black,Large" data-role="tagsinput">
                              ...
                              <div class="row"> <!-- start 6th row  -->
                                 <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" name="discount_price" required=""
                                             class="form-control">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="controls">
                                          <input type="file" name="product_thambnail" required=""
                                             onChange="mainThamUrl(this)" class="form-control">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="controls">
                                          <input type="file" name="multi_img[]" required="" multiple
                              ...
                              <div class="row"> <!-- start 7th row  -->
                                 <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="controls">
                                          <textarea name="short_descp_en" id="textarea" required="" class="form-control" required
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="controls">
                                          <textarea name="short_descp_hin" id="textarea" required="" class="form-control" required
            ...
            if (subcategory_id) {
               $.ajax({
                  ...
                  success: function(data) {
                     ...
                     $.each(data, function(key, value) {
                        $('select[name="subsubcategory_id"]').append('<option value="' + value
                           .id + '">' + value.sub_sub_category_name_en + '</option>');
                     });
                  },
               });
            } else {
