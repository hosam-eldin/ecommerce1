...
@section('title', session()->get('language') == 'hindi' ? $product->product_name_hin . '-विवरण' :
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                           <div class="form-group">
                              ...
                              <select id="pcolor" class="form-control unicase-form-control selectpicker"
                                 style="display: none;">
                        ...
                        <div class="col-sm-6">
                           ...
                           @else
                              <div class="form-group">
                                 ...
                                 <select id="psize" class="form-control unicase-form-control selectpicker"
                                    style="display: none;">
